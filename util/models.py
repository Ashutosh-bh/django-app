...
class TimeStampedModel(models.Model):
    ...
    created_on = models.DateTimeField(default=timezone.localtime, db_column='created_on')
    updated_on = models.DateTimeField(default=timezone.localtime, db_column='updated_on')
